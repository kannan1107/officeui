    ...
    return (
        <nav className="bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200 shadow-sm">
            <div className="max-w-screen-xl flex items-center justify-between mx-auto px-4 py-3">
                ...
                <a href="/" className="text-xl font-bold text-blue-700">MyApp</a>
                    ...
                    {optionsOpen && (
                        <div className="absolute right-0 mt-2 w-48 rounded-md bg-white shadow-lg ring-1 ring-black/5 z-50">
                            <div className="py-1 text-sm text-gray-700">
                                <a href="/stores" className="block px-4 py-2 hover:bg-gray-100">Stores</a>
                                <a href="/new-items" className="block px-4 py-2 hover:bg-gray-100">New Items</a>
                                <a href="/itemList" className="block px-4 py-2 hover:bg-gray-100">Spars</a>
                                <a href="/add-employee" className="block px-4 py-2 hover:bg-gray-100">Add Employee</a>
                                <a href="/employee-list" className="block px-4 py-2 hover:bg-gray-100">Employee List</a>
